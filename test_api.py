...
def test_register_user():
    ...
    """
    # The registration endpoint needs to be /api/auth/register
...
def test_login():
    ...
    """
    # The login endpoint needs to be /api/auth/login
    payload = {"username": "puja", "password": "mypassword"}
    ...
    if not passed:
        print_result("Login Test", passed, "a valid token", res.text, payload, res.text)
